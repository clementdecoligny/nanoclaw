...
RULES = [
    ...
    # ── GROCERIES ──
    (r'CHEN JINGQIANG', 'HOUSE', 'FURNITURE'),
    (r'MOHAMMAD HARUN|MERCEARIA LUIS|MERCEARIA DA ANITA|MERCEARIA ALBERTO ROSA|MERCEAR ALBERTO ROSA', 'GROCERIES', 'SUPER'),
    ...
    # ── VOITURE ──
    (r'EST SERVICO AP-4 LOS PALACIOS|EST SERVICO.*VISTA HERMOSA|EST SERVICO E\.S\. VISTA', 'VOITURE', 'ESSENCE'),

    # ── HOLIDAY ──
    (r'EST SERVICO TALAVERA', 'HOLIDAY', 'MISC'),  # gas stop en route to Seville
    ...
    # ── KIDS ──
    (r'ESCOLA ALEMA LISBOA', 'LEISURE', 'MISC'),  # activities at German school, not tuition
    (r'R\. S AVENTUREIRAS|CENTRO SOC PAR N SENHORA|CENTRO SOC PAR', 'KIDS', 'LEISURE'),
    (r'NYX ABSERVICOS|NYX AB', 'EAT OUT', 'RESTAURANT'),
    ...
    # ── HEALTH ──
    (r'DR.*CARLOS MIGUEL BORGES', 'HEALTH', 'HOSPITAL'),
    ...
    (r'MAS GO FELIPE|FOTO ESTUDIO TABLADA', 'HOLIDAY', 'MISC'),

    # ── GROCERIES (specific transfers) ──
    (r'RODOLFO FREDERICO BEJA', 'GROCERIES', 'SUPER'),  # butcher/produce, misleading Dr. prefix

    # ── LEISURE ──
    (r'AMAZON', 'LEISURE', 'MISC'),
...
# Transfers to named individuals — confirmed babysitters only
BABYSITTER_PATTERNS = [
    r'MATILDE PEREIRA.*CASTRO',
    r'M ISABEL GONCALVES',
]
HEALTH_TRANSFER = [r'DR.*CARLOS MIGUEL BORGES']
GROCERIES_TRANSFER = [r'MARIA LUCIA VELASCO ARBOLI']
