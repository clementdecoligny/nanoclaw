...
One line per recipe. Pepa reads this file for planning — opens individual files only when she needs actual instructions or ingredients.

**Columns:** file | name | category | effort | batch-friendly | notes

---

| File | Name | Category | Effort | Batch | Notes |
|------|------|----------|--------|-------|-------|
| ragu-bolognese.md | Ragù alla Bolognese | pasta / beef | low (passive) | ⭐⭐⭐ | Freeze well. Base for cannelloni, lasagne, pasta. Always make large batch. |
| cannelloni-napoletana.md | Cannelloni alla Napoletana | pasta / beef | medium | ⭐⭐⭐ | Reuses ragu. Assemble day before, bake next day. |
| spaghetti-tomate-aubergine-burrata.md | Spaghetti tomate aubergine burrata | pasta / veg | medium | ⭐⭐ | Sauce can be batched. Assemble at moment. |
| pasta-brocoli.md | Pasta con brócoli | pasta / veg | very low | moderate | Quick weeknight. |
| pasta-tomate-fresco-ajo.md | Pasta con tomate fresco y ajo | pasta / veg | very low | no | At-the-moment only (fresh tomato). |
| espaguetis-alcachofa-alcaparras.md | Espaguetis alcachofa alcaparras | pasta / veg | very low | no | Best at moment. |
| ensaladas-pasta-guia-y-recetas.md | Ensaladas de pasta (guide) | pasta salad / veg | low | ⭐⭐ | Guide with multiple recipes. Good for lunch. |
| pad-thai-pollo.md | Pad Thai de Pollo | chicken / Asian | medium | sauce only | Sauce ahead, assemble at moment. |
| pollo-chipotle.md | Pollo chipotle | chicken / Mexican | low | ⭐⭐ | Batch chicken, use across meals. |
| pollo-vapor-ensalada-anacardos-menta.md | Pollo al vapor ensalada anacardos menta | chicken / salad | medium | partial | Chicken ahead. Salad at moment. |
| salade-lentilles-saumon-avocat-feta.md | Salade lentilles saumon avocat feta | fish / salad | very low | ⭐⭐ | Lentils ahead. Assemble when serving. |
...
| sopa-cenoura-pera-rocha.md | Sopa de Cenoura e Pêra Rocha | soup / veg | very low | ⭐⭐⭐ | Freezes well. |
| soupe-legumes-classique.md | Soupe de Légumes Classique | soup / veg | low | ⭐⭐⭐ | Freezes well. Good for baby too. |
...
| ensalada-hinojo-tomate.md | Ensalada de hinojo y tomate | veg / salad | very low | no | At moment only. |
| caviar-aubergines-micro-ondes.md | Caviar d'aubergines micro-ondes | veg / dip | very low | ⭐⭐ | 4–5 days fridge. |
| hummus-ete-deux-versions.md | Hummus été (2 versions) | veg / dip | low | ⭐⭐ | 4–5 days fridge. |
| aguacate-salsa-chile-tortillas.md | Aguacate salsa chile tortillas | veg / starter | very low | no | Serve immediately. |
| remoulade-hinojo.md | Rémoulade de hinojo | veg / side | low | moderate | |
| coleslaw-sain-ete.md | Coleslaw sain d'été | veg / salad | very low | ⭐⭐ | Chou rouge + lombard + pomme + dressing yaourt. Léger, estival. Accompagnement polyvalent. |
| pate-a-pizza.md | Pâte à pizza maison | dough | low (robot) | ⭐⭐ | Freeze dough balls. |
...
These recipe pairs share a base component — one cook session feeds two meals:

- **Ragu → Cannelloni**: Make a large ragu batch → pasta + baked cannelloni 2 days later
- **Pollo chipotle → Pad Thai**: Batch chicken → Mexican night + Asian night
- **Lentilles → Ensalada**: Cook lentils in bulk → warm salad + cold lentil salad for lunch
- **Soupe légumes → Bébé purée**: Family soup base doubles as baby puree (blend before seasoning)
- **Pizza dough**: Freeze extra dough balls → quick pizza night later in the week
